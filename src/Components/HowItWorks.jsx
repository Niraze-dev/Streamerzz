          ...
          >
            ...
            <div className="flex justify-center">
              <LazyLoadImage
                ...
                alt={feature.title}
                onLoad={() => handleImageLoad(i)} // Mark image as loaded
                className={`mt-8 border-neutral-800 rounded-lg text-sm border w-full overflow-hidden ${
                  loadedImages[i] ? "blur-none" : "blur-lg"
                }`} // Apply blur logic here
              />
            </div>
              ...
              <div className="flex flex-col sm:gap-0 sm:flex-row gap-4 justify-between px-1 items-center mt-4">
                <div className="flex items-center -space-x-2">
                  {feature.users.map((user, ind) => (
                    <img
                      onLoad={() => handleProfileLoad(ind)}
                      className={`${
                        loadedProfile[ind] ? "blur-none" : "blur-lg"
